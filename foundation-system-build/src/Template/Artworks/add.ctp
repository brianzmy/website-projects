                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group ic-cmp-int">
                                ...
                                <div class="nk-int-st">
                                    <?= $this->Form->control('project_id', array('class' => 'form-control', 'options' => $projects, 'empty' => 'Please select the associated project.'))?>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group ic-cmp-int">
                                ...
                                <div class="nk-int-st">
                                    <?= $this->Form->control('gallery_id', array('class' => 'form-control', 'options' => $galleries, 'empty' => 'Please select the associated gallery.' ))?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group ic-cmp-int">
                                ...
                                <div class="nk-int-st">
                                    <?= $this->Form->control('artwork_img',  array('type'=>'file', 'label' => 'Image'))?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <?=    $this->Form->control('artists._ids', [
                        'options' => $artists,
                        'type' => 'hidden'
                    ]);
                    ?>
